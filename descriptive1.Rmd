...
DATA$NEUTRO_PRE_SIC_CELL<-as.numeric(DATA$NEUTRO_PRE_SIC_CELL)
DATA$NEUTRO_POST_SIC_CELL<-as.numeric(DATA$NEUTRO_POST_SIC_CELL)
DATA$EOSINO_POST_SIC_CELL<-as.numeric(DATA$EOSINO_POST_SIC_CELL)
