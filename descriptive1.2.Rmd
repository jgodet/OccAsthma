...
barplotNM(a=cprop(tabtype)[1:4,1:3],b="nombre de reaction tardive selon le phenotype",c=4,d=80,e=c(2,5,8),f=c("no reaction","isolated early","isolated late","dual"))
chisq.test(tablat)
```
...
tabfeno<-table(data$change_feno.17.5ppb,data$t235)
tabfeno
cprop(tabfeno)
