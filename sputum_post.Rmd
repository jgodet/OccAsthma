...
```
```{r}
varshort<-names(dtfp)[!names(dtfp)%in%c("t235","poor sx control","airway ob","method_sic","country","city","id code_local","year","height", "weight","race","job_class","agent_name","job","exposure","nsbh_method","nsbh_agent","nsbh_unit","neutro_pre_sic_cell","neutro_post_sic_cell","t2or50","t235","t235p","t250","t250p","t2tp","eosino_post_sic_cell","eosino_post_sic_cell","post_24_nsbh_value","baseline_nsbh_value","eosino_post_sic.3","agent_category" )]
```


```{r}
tabeo<-CreateTableOne(vars = varshort,strata = "eosino_post_sic.3",data = dtfp,addOverall = TRUE)
