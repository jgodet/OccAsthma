...
DATA$SABA_W_FREQUENCY[DATA$SABA_W_FREQUENCY%in%c("≥3 times a day")]<-"3 times a day or more"
...
DATA$t235 <- ifelse(is.na(DATA$feno_pre_sic) & is.na(DATA$blood_eosino) & is.na(DATA$eosino_pre_sic), NA, ifelse(DATA$feno_pre_sic >= 50 | DATA$blood_eosino >= 300 | DATA$eosino_pre_sic >=3, 1, ifelse(DATA$feno_pre_sic < 50 & DATA$blood_eosino < 300 & DATA$eosino_pre_sic < 3, 0, NA)))
