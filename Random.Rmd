...
darf<-darf%>%select(age,sex,bmi,smok.cur,smok.nev,smok.ex,educ1,educ2,educ3,gina0,gina1,gina2,gina3,gina4,gina5,saba0,saba1,saba2,saba3,saba4,asthma_work_time,time_last_exp_m_norm,asthma_delay,baseline_fev1,baseline_fvc,fev1_fvc,nsbh1,nsbh2,nsbh3)
...
darfi <- as.data.frame(sapply(darfi, function(x) as.numeric(x)))
 ...
 fit.rf <- randomForest(darfi[,],proximity=T,oob.prox = TRUE,ntree = 1000)
```
