---
title: "descriptive variable T2 critère FeNO 35"
...
```{r}
varshort<-names(data)[!names(data)%in%c("t235","gina 4-5","poor sx control","exa_2","airway ob","method_sic","country","city","id code_local","year","height", "weight","race","job_class","agent_name","job","exposure","nsbh_method","nsbh_agent","nsbh_unit","baseline_nsbh_value","type_reaction","neutro_pre_sic_cell","neutro_post_sic_cell","t2or50","eosino_pre_sic_cell","eosino_post_sic_cell","post_24_nsbh_value" )]
```
